...
import org.example.operations.CategoryHandler;
import org.example.operations.ProductHandler;
import org.example.operations.ProductPurchase;
import org.example.operations.ProductUpdater;
import org.example.threads.PurchaseProductThread;
import org.example.threads.RemoveProductThread;
import org.example.threads.UpdateProductThread;
            ...
            while (true) {
                ...
                switch (option) {
                    ...
                    case 11:
                        ...
                        break;
                    case 12:
                        productPurchase.exportPurchaseHistoryToExcel("purchase_history.xlsx");
                        break;
